...
public class adminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CS", "ECE", "IT", "ECE" }));
...
//            st.executeUpdate("Insert into student(rollno,branchName,course,name,gender,fathername) values('"+roll+"','"+branchName+"','"+nameAbcd+"','"+name+"','"+gender+"','"+fathername+"')");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try
        {
           Class.forName("com.mysql.cj.jdbc.Driver");
            ...
            Statement st=con.createStatement();
//            ResultSet rs=st.executeQuery("select * from student where rollno='"+roll+"'");
            st.executeUpdate("Insert into student(rollno,branchName,course,name,gender,fathername) values('"+roll+"','"+branchName+"','"+course+"','"+name+"','"+gender+"','"+fathername+"')");
            JOptionPane.showMessageDialog(null, "Result added Successfully!!!");
            setVisible(false);
            new adminHome().setVisible(true);
        }
